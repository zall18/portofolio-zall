...
const EXPERIENCES = [
    ...
    },
    {
        ...
        description: 'Building and implementing a RESTful API using Node.js and Express.js to integrate IoT devices(such as the ESP32) with the Antares platform.',
        skills: ['Node JS', 'Express JS', 'IOT'],
    },
    {
        level: 3,
        ...
        skills: ['Communication', 'Presentation', 'Guidance'],
    },
    {
        level: 4,
        ...
        period: 'Des 2025 — Now',
        description: 'Mentored students on mobile development with Flutter. Organized workshops and coding sessions.',
